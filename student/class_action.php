...
if(isset($_POST["action"])) {
    if($_POST["action"] == "fetch") {
        $query = "
        SELECT tbl_class.class_id, tbl_course.course_id,tbl_course.course_name,
		concat(tbl_course.course_id,' - ',tbl_course.course_name) as course, 
        tbl_teacher.teacher_name

		FROM tbl_class_student
		INNER JOIN tbl_class ON tbl_class_student.class_id = tbl_class.class_id
		...
		WHERE tbl_class_student.student_id  = '".$_SESSION["student_id"]."' AND (
		";
