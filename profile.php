    ...
    <form method="post" id="profile_form" enctype="multipart/form-data">
		...
		<div class="card-body">
			<div class="form-group">
				<div class="row">
					<label class="col-md-4 text-right">Teacher Name</label>
					<div class="col-md-8">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-8">
						<input type="text" name="teacher_emailid" id="teacher_emailid" class="form-control" readonly/>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-8">
						<input type="password" name="teacher_password" id="teacher_password" class="form-control" placeholder="Leave blank to not change" />
			...
			<div class="form-group">
				<div class="row">
					<label class="col-md-4 text-right">Date of Joining</label>
					<div class="col-md-8">
...
$('#teacher_doj').val("<?php echo date("d/m/Y",strtotime($row["teacher_doj"])); ?>");
